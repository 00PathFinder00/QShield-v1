...
ax1.set_title(r'(a) Projector $\pi$', font2)
ax1.grid(linestyle='--', zorder=1, axis='x', alpha=0.5, which='minor')
ax1.barh(y=range(len(op_x_data)), width=nai_p_y_data, label='Baseline', zorder=2, color='seagreen', edgecolor='seagreen', linewidth=0.5, alpha=1, height=bar_width)
ax1.barh(y=np.arange(len(op_x_data))+ 1*bar_width, width=sgx_p_y_data, label='QShield', zorder=2, color='goldenrod', edgecolor='goldenrod', linewidth=0.5, alpha=1, height=bar_width)
ax1.barh(y=np.arange(len(op_x_data))+ 2*bar_width, width=cdb_p_y_data, label='CryptDB', zorder=2, color='slategrey', edgecolor='slategrey', linewidth=0.5, alpha=1, height=bar_width)
...
for y, x in enumerate(sgx_p_y_data):
    ax1.text(x+0.3 if (x >= 0) else x-0.2, y+0.05 if (x >= 0) else y+0.1, '%s' % float('%.3f' % sgx_p_exe_time_ms[y]), ha='center', va='bottom', fontdict=font4)
...
ax2.set_title(r'(b) Selector $\sigma$', font2)
ax2.grid(linestyle='--', zorder=1, axis='x', alpha=0.5, which='minor')
ax2.barh(y=range(len(op_x_data)), width=nai_s_y_data, label='Baseline', zorder=2, color='seagreen', edgecolor='seagreen', linewidth=0.5, alpha=1, height=bar_width)
ax2.barh(y=np.arange(len(op_x_data))+ 1*bar_width, width=sgx_s_y_data, label='QShield', zorder=2, color='goldenrod', edgecolor='goldenrod', linewidth=0.5, alpha=1, height=bar_width)
ax2.barh(y=np.arange(len(op_x_data))+ 2*bar_width, width=cdb_s_y_data, label='CryptDB', zorder=2, color='slategrey', edgecolor='slategrey', linewidth=0.5, alpha=1, height=bar_width)
...
for y, x in enumerate(sgx_s_y_data):
    ax2.text(x+0.3 if (x >= 0) else x-0.2, y+0.05 if (x >= 0) else y+0.1, '%s' % float('%.3f' % sgx_s_exe_time_ms[y]), ha='center', va='bottom', fontdict=font4)
...
ax3.set_title(r'(c) Aggregator $\phi$', font2)
ax3.grid(linestyle='--', zorder=1, axis='x', alpha=0.5, which='minor')
ax3.barh(y=range(len(op_x_data)), width=nai_a_y_data, label='Baseline', zorder=2, color='seagreen', edgecolor='seagreen', linewidth=0.5, alpha=1, height=bar_width)
ax3.barh(y=np.arange(len(op_x_data))+ 1*bar_width, width=sgx_a_y_data, label='QShield', zorder=2, color='goldenrod', edgecolor='goldenrod', linewidth=0.5, alpha=1, height=bar_width)
ax3.barh(y=np.arange(len(op_x_data))+ 2*bar_width, width=cdb_a_y_data, label='CryptDB', zorder=2, color='slategrey', edgecolor='slategrey', linewidth=0.5, alpha=1, height=bar_width)
...
for y, x in enumerate(sgx_a_y_data):
    ax3.text(x+0.3 if (x >= 0) else x-0.2, y+0.05 if (x >= 0) else y+0.1, '%s' % float('%.3f' % sgx_a_exe_time_ms[y]), ha='center', va='bottom', fontdict=font4)
...
ax4.set_title(r'(d) Nested Join $\gamma$', font2)
ax4.grid(linestyle='--', zorder=1, axis='x', alpha=0.5, which='minor')
ax4.barh(y=range(len(op_j_x_data)), width=nai_j_y_data, label='Baseline', zorder=2, color='seagreen', edgecolor='seagreen', linewidth=0.5, alpha=1, height=bar_width)
ax4.barh(y=np.arange(len(op_j_x_data))+ 1*bar_width, width=sgx_j_y_data, label='QShield', zorder=2, color='goldenrod', edgecolor='goldenrod', linewidth=0.5, alpha=1, height=bar_width)
ax4.barh(y=np.arange(len(op_j_x_data))+ 2*bar_width, width=cdb_j_y_data, label='CryptDB', zorder=2, color='slategrey', edgecolor='slategrey', linewidth=0.5, alpha=1, height=bar_width)
...
for y, x in enumerate(sgx_j_y_data):
    ax4.text(x+0.3 if (x >= 0) else x-0.2, y+0.05 if (x >= 0) else y+0.1, '%s' % float('%.3f' % sgx_j_exe_time_ms[y]), ha='center', va='bottom', fontdict=font4)
